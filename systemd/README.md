...
| `modidx-watch20.timer` | **`disabled` до 20.09** | вартовий гілки 20.0 кожні 15 хв |
...
`modidx-watch20.timer` встановлений і перевірений вручну, але **вимкнений**: до появи
гілки платформи повний обхід 232 репозиторіїв кожні 15 хвилин — трафік без інформації.
Увімкнути 20.09: `systemctl enable --now modidx-watch20.timer`.
